    ...
    try {
      ...
      const reportPromises = employees.map(employee => {
        ...
        if (reportData && (reportData.cantidadVentas || reportData.montoVentas || reportData.descripcion)) {
          return axios.post(`${process.env.REACT_APP_API_URL || 'https://reportes-sm2g.onrender.com'}/api/reports`, {
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        {existingReports.length > 0 && (
          <div style={{ marginBottom: '30px' }}>
            <h2 style={{ color: 'white' }}>Reportes Existentes</h2>
                  ...
                  onClick={async () => {
                    try {
                      await axios.post(`${process.env.REACT_APP_API_URL || 'https://reportes-sm2g.onrender.com'}/api/reports`, {
                        ...
                        cantidadVentas: parseInt(editingReport.cantidadVentas) || 0,
                        montoVentas: parseFloat(editingReport.montoVentas) || 0,
                      ...
                      alert('Error al actualizar reporte: ' + (error.response?.data?.message || error.message));
                    }
                  }}
                  style={{
                    padding: '8px 16px',
