      ...
      <div style={{ 
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ 
            ...
            <div>
              <h2 style={{ color: '#fff', marginBottom: '5px', fontSize: '24px' }}>Crear Cuenta</h2>
              <p style={{ color: 'rgba(255, 255, 255, 0.8)', fontSize: '14px', margin: 0 }}>Solicita acceso al sistema</p>
            </div>
          </div>
